...
import "../../../../projects/charts/bar-chart/src/bar-chart";
import namedStyles from "./bar-chart-view.scss?inline";
import sharedStyles from "../../../shared/styles.scss?inline";

@customElement("bar-chart-view")
export default class BarChartView extends LitElement {
  constructor() {
    super();
  }
  ...
  render() {
    const iframeSrc = `${import.meta.env.BASE_URL}charts/bar-chart`;
