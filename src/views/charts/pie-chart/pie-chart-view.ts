...
import "../../../../projects/charts/pie-chart/src/pie-chart";
import namedStyles from "./pie-chart-view.scss?inline";
import sharedStyles from "../../../shared/styles.scss?inline";

@customElement("pie-chart-view")
export default class PieChartView extends LitElement {
  constructor() {
    super();
  }
  ...
  render() {
    const iframeSrc = `${import.meta.env.BASE_URL}charts/pie-chart`;
